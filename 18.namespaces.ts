...
console.log(
  "Calling 'printNamespace(\"namespaceArgument\")' function from 'namespaceA.ts' file in the '18.namespaces.ts' file\n",
  PrintNamespace.printNamespace("namespaceArgument")
);
console.log(
  "Calling 'helloNamespacee()' function from 'namespaceB.ts' file in the '18.namespaces.ts' file\n",
...
console.log(
  "window.namespaceVariable  --->  Property 'namespaceVariable' does not exist on type 'Window & typeof globalThis'"
);
// console.log(
...
// );
console.log(
  "HelloNamespace.namespaceVariable  --->  Property 'namespaceVariable' does not exist on type 'typeof HelloNamespace'"
);
